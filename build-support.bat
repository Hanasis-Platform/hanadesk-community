...
:: HanaDesk Community - Build SUPPORT edition
:: Output: ..\test-support\ - Support (outgoing only, asInvoker)
...
echo ================================================================
echo  Building SUPPORT edition - Version %VERSION%
echo ================================================================
echo.
...
echo [DONE] %OUTPUT_BASE%\test-support\HanaDeskCommunitySupport-%VERSION%-install.exe
endlocal
exit /b 0
