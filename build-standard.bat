...
:: HanaDesk Community - Build STANDARD edition
:: Output: ..\test-standard\ - Standard (full mode, asInvoker)
...
echo ================================================================
echo  Building STANDARD edition - Version %VERSION%
echo ================================================================
echo.
...
echo [DONE] %OUTPUT_BASE%\test-standard\HanaDeskCommunity-%VERSION%-install.exe
endlocal
exit /b 0
